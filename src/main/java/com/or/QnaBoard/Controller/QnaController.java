...
public class QnaController {
	...
	public String contentsInsert(Model model, QnaVo vo) {
		/* service.insert() */
		return "redirect:showBoard"; // controller - controller 메서드가 다른 메서드를 부르는거
	}
	
	@RequestMapping("/change")
	public String contentsUpdate(Model model, QnaVo vo) {
		/* service.updateBoard */
		vo.getQ_num();
		return "redirect:showBoard";	
	}
	@RequestMapping("/delete")
	public String contentsDelete(Model model, QnaVo vo) {
		/* service.deleteBoard */
		vo.getQ_num();
		return "redirect:showBoard";	
	}
